        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    CampusName = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EvaluateType = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ratings", x => x.PurchaseTicketId);
                    table.ForeignKey(
                        name: "FK_Ratings_PurchaseTickets_PurchaseTicketId",
                        column: x => x.PurchaseTicketId,
                        principalTable: "PurchaseTickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostTickets_ProductId",
                table: "PostTickets",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_PostTickets_UserId",
                table: "PostTickets",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseTickets_ProductId",
